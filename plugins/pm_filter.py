...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('MOVIES BOT', url='https://t.me/+t6R7tKJZiUI1OGJk'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS CHANNEL 🤖', url='https://t.me/JUVENILETIDES')
        ], [
